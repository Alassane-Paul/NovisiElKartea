...
<div class="max-w-4xl mx-auto">
    ...
    <div class="bg-white rounded-lg shadow-md overflow-hidden">
        <div class="p-6 border-b border-gray-200">
            <h2 class="text-xl font-bold text-gray-800">Modifier : <?php echo e($project->title['es'] ?? 'Projet'); ?></h2>
        </div>

        <form action="<?php echo e(route('admin.projects.update', $project)); ?>" method="POST" enctype="multipart/form-data" class="p-6">
            <?php echo csrf_field(); ?>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                ...
                <div>
                    ...
                    <select name="slug" class="w-full px-3 py-2 border rounded border-gray-300 focus:outline-none focus:border-blue-500">
                        <option value="afrikarte" <?php echo e(old('slug', $project->slug) == 'afrikarte' ? 'selected' : ''); ?>>Afrikarte</option>
                        <option value="diversidad" <?php echo e(old('slug', $project->slug) == 'diversidad' ? 'selected' : ''); ?>>Diversidad</option>
                        <option value="igualdad" <?php echo e(old('slug', $project->slug) == 'igualdad' ? 'selected' : ''); ?>>Igualdad</option>
                        <option value="new-generation" <?php echo e(old('slug', $project->slug) == 'new-generation' ? 'selected' : ''); ?>>New Generation</option>
                    </select>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div>
                    ...
                    <select name="category" class="w-full px-3 py-2 border rounded border-gray-300 focus:outline-none focus:border-blue-500">
                        <option value="education" <?php echo e(old('category', $project->category) == 'education' ? 'selected' : ''); ?>>Education</option>
                        <option value="culture" <?php echo e(old('category', $project->category) == 'culture' ? 'selected' : ''); ?>>Culture</option>
                        <option value="social" <?php echo e(old('category', $project->category) == 'social' ? 'selected' : ''); ?>>Social</option>
                    </select>
                </div>
                ...
                <div>
                    <label class="flex items-center mt-8">
                        <input type="checkbox" name="featured" value="1" <?php echo e(old('featured', $project->featured) ? 'checked' : ''); ?> class="form-checkbox h-5 w-5 text-blue-600">
            ...
            <div class="mb-6">
                ...
                <div class="mb-2">
                    <img src="<?php echo e(asset('storage/' . $project->image)); ?>" alt="Image actuelle" class="h-32 rounded">
                </div>
                <?php endif; ?>
            ...
            <div id="content-<?php echo e($lang); ?>" class="<?php echo e($lang === 'es' ? '' : 'hidden'); ?> lang-content">
                <div class="mb-4">
                    ...
                    <input type="text" name="title[<?php echo e($lang); ?>]" value="<?php echo e(old('title.'.$lang, $project->title[$lang] ?? '')); ?>" class="w-full px-3 py-2 border rounded border-gray-300 focus:outline-none focus:border-teal-500">
                </div>

                <div class="mb-4">
                    <label class="block text-gray-700 font-bold mb-2">Description courte (<?php echo e(strtoupper($lang)); ?>)</label>
                    <textarea name="description[<?php echo e($lang); ?>]" rows="5" class="w-full px-3 py-2 border rounded border-gray-300 focus:outline-none focus:border-teal-500"><?php echo e(old('description.'.$lang, $project->description[$lang] ?? '')); ?></textarea>
                </div>

                <div class="mb-4">
                    <label class="block text-gray-700 font-bold mb-2">Contenu (<?php echo e(strtoupper($lang)); ?>)</label>
                    <textarea name="content[<?php echo e($lang); ?>]" rows="15" class="w-full px-3 py-2 border rounded border-gray-300 focus:outline-none focus:border-teal-500"><?php echo e(old('content.'.$lang, $project->content[$lang] ?? '')); ?></textarea>
                </div>
            </div>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Projets\Gombo\NovisiElKartea\resources\views\admin\projects\edit.blade.php ENDPATH**/ ?>