...
<?php $__env->startSection('title', $project->title[app()->getLocale()] ?? $project->title['es']); ?>
...
<div class="overflow-hidden bg-white">
    ...
    <section class="relative min-h-[40vh] md:min-h-[50vh] flex items-center justify-center pt-12 md:pt-16 pb-12">
        <div class="absolute inset-0 z-0 bg-gradient-to-br from-teal-900 to-[#00695c]">
            ...
            <img src="<?php echo e(asset('storage/' . $project->image)); ?>" class="w-full h-full object-cover opacity-30" alt="<?php echo e($project->title[app()->getLocale()] ?? $project->title['es']); ?>">
            <?php endif; ?>
        ...
        <div class="container mx-auto px-4 relative z-20 text-white text-center">
            <span class="text-teal-200 font-bold uppercase tracking-widest text-xs mb-4 block animate-fade-in-down"><?php echo e($project->category ?? __('messages.general')); ?></span>
        ...
        <div class="container mx-auto px-4">
            <div class="max-w-4xl mx-auto">
                ...
                <div class="text-xl md:text-2xl text-teal-900 font-medium mb-12 italic leading-relaxed text-center" data-aos="fade-up" data-aos-delay="100">
                    <?php echo $project->description[app()->getLocale()] ?? $project->description['es']; ?>

                </div>

                
                <div class="prose prose-lg max-w-none text-gray-700 leading-relaxed content-justified" data-aos="fade-up" data-aos-delay="200">
                    <?php echo $project->content[app()->getLocale()] ?? $project->content['es']; ?>

                </div>

                
                <div class="mt-12 bg-teal-50 rounded-3xl p-8 md:p-12 text-center border border-teal-100" data-aos="zoom-in">
                    <h3 class="text-2xl font-bold text-teal-900 mb-6"><?php echo e(__('messages.project_interest_title')); ?></h3>
                    <p class="text-gray-600 mb-8 max-w-2xl mx-auto">
                        <?php echo e(__('messages.project_interest_desc')); ?>

                    </p>
                    <a href="<?php echo e(route('contact.index')); ?>" class="inline-flex items-center justify-center bg-teal-800 hover:bg-teal-900 text-white font-bold py-4 px-10 rounded-2xl shadow-lg transition-all transform hover:-translate-y-1">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Projets\Gombo\NovisiElKartea\resources\views\projects\show.blade.php ENDPATH**/ ?>