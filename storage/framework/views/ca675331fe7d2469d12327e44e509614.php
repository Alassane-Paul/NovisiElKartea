<?php $__env->startSection('title', 'Modifier le Service'); ?>
...
<div class="max-w-4xl mx-auto">
    ...
    <div class="bg-white rounded-lg shadow-md overflow-hidden">
        <div class="p-6 border-b border-gray-200">
            <h2 class="text-xl font-bold text-gray-800">Modifier : <?php echo e($service->title['es'] ?? 'Service'); ?></h2>
        </div>

        <form action="<?php echo e(route('admin.services.update', $service)); ?>" method="POST" enctype="multipart/form-data" class="p-6">
            <?php echo csrf_field(); ?>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                <div>
                    ...
                    <select name="category" class="w-full px-3 py-2 border rounded border-gray-300 focus:outline-none focus:border-teal-500">
                        ...
                        <option value="<?php echo e($key); ?>" <?php echo e(old('category', $service->category) === $key ? 'selected' : ''); ?>><?php echo e($label); ?></option>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div>
                    ...
                    <input type="text" name="slug" id="slug" value="<?php echo e(old('slug', $service->slug)); ?>" class="w-full px-3 py-2 border rounded border-gray-300 focus:outline-none focus:border-teal-500">
...
unset($__errorArgs, $__bag); ?>
                ...
                <div>
                    ...
                    <select name="icon" class="w-full px-3 py-2 border rounded border-gray-300 focus:outline-none focus:border-teal-500">
                        ...
                        <option value="<?php echo e($class); ?>" <?php echo e(old('icon', $service->icon) === $class ? 'selected' : ''); ?>><?php echo e($name); ?> (<?php echo e($class); ?>)</option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </select>
                </div>
                ...
                <div>
                    ...
                    <input type="number" name="order" value="<?php echo e(old('order', $service->order)); ?>" class="w-full px-3 py-2 border rounded border-gray-300 focus:outline-none focus:border-teal-500">
                </div>

                <div>
                    <label class="block text-gray-700 font-bold mb-2">Statut</label>
                    <label class="flex items-center mt-2">
                        <input type="checkbox" name="active" value="1" <?php echo e(old('active', $service->active) ? 'checked' : ''); ?> class="form-checkbox h-5 w-5 text-teal-600">
            ...
            <div class="mb-6">
                ...
                <div class="mb-2">
                    <img src="<?php echo e(asset('storage/' . $service->image)); ?>" alt="Image actuelle" class="h-32 rounded">
                </div>
                <?php endif; ?>
            ...
            <div id="content-<?php echo e($lang); ?>" class="<?php echo e($lang === 'es' ? '' : 'hidden'); ?> lang-content">
                <div class="mb-4">
                    ...
                    <input type="text" name="title[<?php echo e($lang); ?>]" value="<?php echo e(old('title.'.$lang, $service->title[$lang] ?? '')); ?>" class="w-full px-3 py-2 border rounded border-gray-300 focus:outline-none focus:border-teal-500">
                </div>

                <div class="mb-4">
                    <label class="block text-gray-700 font-bold mb-2">Description courte (<?php echo e(strtoupper($lang)); ?>)</label>
                    <textarea name="description[<?php echo e($lang); ?>]" rows="3" class="w-full px-3 py-2 border rounded border-gray-300 focus:outline-none focus:border-teal-500"><?php echo e(old('description.'.$lang, $service->description[$lang] ?? '')); ?></textarea>
                </div>

                <div class="mb-4">
                    <label class="block text-gray-700 font-bold mb-2">Contenu (<?php echo e(strtoupper($lang)); ?>)</label>
                    <textarea name="content[<?php echo e($lang); ?>]" rows="10" class="w-full px-3 py-2 border rounded border-gray-300 focus:outline-none focus:border-teal-500"><?php echo e(old('content.'.$lang, $service->content[$lang] ?? '')); ?></textarea>
                </div>
            </div>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<script>
    ...
    if (titleEs && slugInput && !slugInput.value) {
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Projets\Gombo\NovisiElKartea\resources\views\admin\services\edit.blade.php ENDPATH**/ ?>