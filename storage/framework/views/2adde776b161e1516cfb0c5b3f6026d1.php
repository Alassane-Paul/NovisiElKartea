<?php $__env->startSection('title', 'Nouveau Partenaire'); ?>
            ...
            <form action="<?php echo e(route('admin.partners.store')); ?>" method="POST" enctype="multipart/form-data" class="p-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                    ...
                    <div>
                        ...
                        <input type="url" name="website" value="<?php echo e(old('website')); ?>" placeholder="https://..." class="w-full px-3 py-2 border rounded border-gray-300 focus:outline-none focus:border-teal-500">
                    </div>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Projets\Gombo\NovisiElKartea\resources\views\admin\partners\create.blade.php ENDPATH**/ ?>