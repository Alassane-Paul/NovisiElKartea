<?php $__env->startSection('title', $page->title[app()->getLocale()] ?? $page->title['es']); ?>
...
<div class="overflow-hidden">
    ...
    <section class="relative min-h-[60vh] flex items-center justify-center pt-12 md:pt-16">
        ...
        <div class="absolute inset-0 z-0">
            <img src="<?php echo e(asset('storage/' . $page->featured_image)); ?>" class="w-full h-full object-cover" alt="<?php echo e($page->title[app()->getLocale()] ?? $page->title['es']); ?>">
        ...
        <div class="container mx-auto px-4 relative z-20 text-white py-12">
            <div class="max-w-4xl">
                ...
                <h1 class="text-4xl md:text-6xl font-bold mb-6 leading-tight animate-fade-in-up" data-aos="fade-down" data-aos-duration="1000">
                    <?php echo e($page->title[app()->getLocale()] ?? $page->title['es']); ?>
                ...
                <div class="mt-12 bg-gray-50 rounded-3xl p-8 md:p-12 border border-gray-100 shadow-sm relative overflow-hidden group hover:shadow-md transition-shadow duration-300" data-aos="zoom-in-up" data-aos-duration="1000">
                    ...
                    <div class="relative z-10 flex flex-col md:flex-row items-center justify-between gap-8">
                        <div class="text-center md:text-left">
                            <h3 class="text-2xl font-bold text-teal-900 mb-2"><?php echo e(__('about.cta_title')); ?></h3>
                            <p class="text-gray-600 max-w-md"><?php echo e(__('about.cta_description')); ?></p>
                        </div>
                        <a href="<?php echo e(route('join.index')); ?>" class="inline-flex items-center justify-center bg-[#ff9800] hover:bg-[#f57c00] text-white font-bold py-4 px-10 rounded-2xl shadow-lg transition-all duration-300 transform hover:-translate-y-1">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Projets\Gombo\NovisiElKartea\resources\views\about\what.blade.php ENDPATH**/ ?>