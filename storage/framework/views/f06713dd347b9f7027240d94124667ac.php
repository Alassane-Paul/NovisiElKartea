<?php $__env->startSection('title', 'Modifier la Page'); ?>
    ...
    <div class="max-w-4xl mx-auto">
        ...
        <div class="bg-white rounded-lg shadow-md overflow-hidden">
            <div class="p-6 border-b border-gray-200">
                <h2 class="text-xl font-bold text-gray-800">Modifier : <?php echo e($page->title['es'] ?? 'Page'); ?></h2>
            </div>
            
            <form action="<?php echo e(route('admin.pages.update', $page)); ?>" method="POST" enctype="multipart/form-data" class="p-6">
                <?php echo csrf_field(); ?>
                    ...
                    <div>
                        ...
                        <select name="slug" class="w-full px-3 py-2 border rounded border-gray-300 focus:outline-none focus:border-teal-500">
                            <?php $__currentLoopData = App\Models\Page::PAGES; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $slug => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($slug); ?>" <?php echo e(old('slug', $page->slug) === $slug ? 'selected' : ''); ?>><?php echo e($label); ?> (<?php echo e($slug); ?>)</option>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        <label class="block text-gray-700 font-bold mb-2">Statut</label>
                         <label class="flex items-center mt-2">
                            <input type="checkbox" name="active" value="1" <?php echo e(old('active', $page->active) ? 'checked' : ''); ?> class="form-checkbox h-5 w-5 text-teal-600">
                ...
                <div class="mb-6">
                    ...
                    <?php if($page->featured_image): ?>
                        <div class="mb-2">
                            <img src="<?php echo e(asset('storage/' . $page->featured_image)); ?>" alt="Image actuelle" class="h-32 rounded object-cover">
                        </div>
                    <?php endif; ?>
                ...
                <div id="content-<?php echo e($lang); ?>" class="<?php echo e($lang === 'es' ? '' : 'hidden'); ?> lang-content">
                    <div class="mb-4">
                        ...
                        <input type="text" name="title[<?php echo e($lang); ?>]" value="<?php echo e(old('title.'.$lang, $page->title[$lang] ?? '')); ?>" class="w-full px-3 py-2 border rounded border-gray-300 focus:outline-none focus:border-teal-500">
                    </div>
                    
                    <div class="mb-4">
                        <label class="block text-gray-700 font-bold mb-2">Contenu (<?php echo e(strtoupper($lang)); ?>)</label>
                        <textarea name="content[<?php echo e($lang); ?>]" rows="15" class="w-full px-3 py-2 border rounded border-gray-300 focus:outline-none focus:border-teal-500"><?php echo e(old('content.'.$lang, $page->content[$lang] ?? '')); ?></textarea>
                    </div>
                </div>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Projets\Gombo\NovisiElKartea\resources\views\admin\pages\edit.blade.php ENDPATH**/ ?>