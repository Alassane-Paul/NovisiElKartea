<?php $__env->startSection('title', 'Modifier la Traduction'); ?>
    ...
    <div class="max-w-4xl mx-auto">
        ...
        <div class="bg-white rounded-lg shadow-md overflow-hidden">
            <div class="p-6 border-b border-gray-200">
                <h2 class="text-xl font-bold text-gray-800">Modifier : <?php echo e($translation->group); ?>.<?php echo e($translation->key); ?></h2>
            </div>
            
            <form action="<?php echo e(route('admin.translations.update', $translation)); ?>" method="POST" class="p-6">
                <?php echo csrf_field(); ?>
                <?php echo method_field('PUT'); ?>
                
                <div class="mb-6">
                    <label class="block text-gray-700 font-bold mb-2">Notes (Contexte)</label>
                    <textarea name="notes" rows="2" class="w-full px-3 py-2 border rounded border-gray-300 focus:outline-none focus:border-teal-500"><?php echo e(old('notes', $translation->notes)); ?></textarea>
                </div>
                ...
                <div id="content-<?php echo e($lang); ?>" class="<?php echo e($lang === 'es' ? '' : 'hidden'); ?> lang-content">
                    <div class="mb-4">
                        ...
                        <textarea name="text[<?php echo e($lang); ?>]" rows="5" class="w-full px-3 py-2 border rounded border-gray-300 focus:outline-none focus:border-teal-500"><?php echo e(old('text.'.$lang, $translation->text[$lang] ?? '')); ?></textarea>
                    </div>
                </div>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Projets\Gombo\NovisiElKartea\resources\views\admin\translations\edit.blade.php ENDPATH**/ ?>