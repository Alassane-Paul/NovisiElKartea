<?php $__env->startSection('title', __('about.partners_title')); ?>
...
<div class="overflow-hidden">
    ...
    <section class="relative min-h-[60vh] flex items-center justify-center pt-20">
        ...
        <div class="absolute inset-0 z-0">
            <img src="<?php echo e(asset('storage/' . $page->featured_image)); ?>" class="w-full h-full object-cover" alt="<?php echo e(__('about.partners_title')); ?>">
        ...
        <div class="container mx-auto px-4 relative z-20 text-white py-12">
            <div class="max-w-4xl">
                ...
                <h1 class="text-4xl md:text-6xl font-bold mb-6 leading-tight animate-fade-in-up" data-aos="fade-down" data-aos-duration="1000">
                    <?php echo e($page->title[app()->getLocale()] ?? $page->title['es'] ?? __('about.partners_title')); ?>
...
<div class="container mx-auto px-4 py-12">
    <?php if($page && (isset($page->content[app()->getLocale()]) || isset($page->content['es']))): ?>
    ...
    <div class="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-8 items-center overflow-hidden">
        ...
        <div class="bg-white p-6 rounded-lg premium-contour flex items-center justify-center duration-300"
            data-aos="zoom-in" data-aos-delay="<?php echo e(($index % 6) * 50); ?>">
            <?php if($partner->logo): ?>
            <img src="<?php echo e(asset('storage/' . $partner->logo)); ?>" class="max-h-24 object-contain" alt="<?php echo e($partner->name[app()->getLocale()] ?? $partner->name['es']); ?>">
            <?php else: ?>
            <span class="text-gray-400 font-bold uppercase tracking-widest text-xs"><?php echo e($partner->name[app()->getLocale()] ?? $partner->name['es']); ?></span>
            <?php endif; ?>
        </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Projets\Gombo\NovisiElKartea\resources\views\about\partners.blade.php ENDPATH**/ ?>