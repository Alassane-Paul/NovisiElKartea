<?php $__env->startSection('title', __('header.projects')); ?>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
                ...
                <div class="group bg-white rounded-2xl overflow-hidden premium-contour transition-all duration-500 hover:-translate-y-2 flex flex-col"
                    ...
                    <div class="aspect-[4/3] overflow-hidden relative">
                        ...
                        <img src="<?php echo e(asset('storage/' . $project->image)); ?>" class="w-full h-full object-cover transition-transform duration-700 group-hover:scale-110" alt="<?php echo e($project->title[app()->getLocale()] ?? $project->title['es']); ?>">
                        <?php else: ?>
                    ...
                    <div class="p-8 flex-grow flex flex-col">
                        <span class="text-teal-600 font-bold uppercase tracking-widest text-[10px] mb-3 block italic"><?php echo e($project->category ?? __('messages.general')); ?></span>
                        <h3 class="text-2xl font-bold text-teal-900 mb-4 leading-tight group-hover:text-orange-600 transition-colors">
                            <?php echo e($project->title[app()->getLocale()] ?? $project->title['es']); ?>

                        </h3>
                        <p class="text-gray-600 mb-8 line-clamp-3 text-sm leading-relaxed">
                            <?php echo e(strip_tags($project->description[app()->getLocale()] ?? $project->description['es'] ?? '')); ?>

                        </p>
                        <div class="mt-auto pt-6 border-t border-gray-50 flex items-center justify-between">
                            <span class="text-xs text-gray-400 flex items-center">
                                <i class="far fa-calendar-alt mr-2"></i>
                                <?php echo e($project->start_date ? $project->start_date->format('M Y') : '---'); ?>

                            </span>
                            <a href="<?php echo e(route('projects.show', $project->slug)); ?>" class="text-teal-800 font-bold text-sm flex items-center hover:text-orange-600 transition-colors">
                ...
                <div class="col-span-full text-center py-12 bg-gray-50 rounded-[3rem] border-2 border-dashed border-gray-200" data-aos="fade-up">
                    <i class="fas fa-folder-open text-gray-300 text-6xl mb-6"></i>
                    <h3 class="text-xl font-bold text-gray-500"><?php echo e(__('messages.no_projects')); ?></h3>
                </div>
                <?php endif; ?>
            </div>
        </div>
    ...
    <section class="py-10 md:py-16 bg-gray-50 overflow-hidden">
        <div class="container mx-auto px-4" data-aos="fade-up">
            <div class="max-w-4xl mx-auto text-center">
                <h2 class="text-3xl md:text-4xl font-bold text-teal-900 mb-8"><?php echo e(__('messages.projects_cta_title')); ?></h2>
                <p class="text-gray-600 text-lg mb-12 leading-relaxed">
                    <?php echo e(__('messages.projects_cta_description')); ?>

                </p>
                <a href="<?php echo e(route('contact.index')); ?>" class="inline-flex items-center justify-center bg-teal-800 hover:bg-teal-900 text-white font-bold py-4 px-12 rounded-2xl shadow-xl transition-all transform hover:-translate-y-1">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Projets\Gombo\NovisiElKartea\resources\views\projects\index.blade.php ENDPATH**/ ?>